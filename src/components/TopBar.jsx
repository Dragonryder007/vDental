...
const TopBar = () => (
  ...
  >
    ...
    <div className="flex items-center h-full divide-x divide-white/[0.07]">
      ...
      >
        <span className="ms text-[16px] flex-shrink-0" style={{ color: 'var(--gold)' }} aria-hidden="true">lightbulb</span>
      ...
      <a
        ...
        className="group h-full flex items-center gap-2 px-4 sm:px-6 lg:px-8 transition-all duration-200 hover:bg-white/[0.03]"
      >
        <span className="ms text-[16px] flex-shrink-0" style={{ color: 'var(--gold)' }} aria-hidden="true">call</span>
