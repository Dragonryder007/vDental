    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 min-h-[300px]">
        ...
        <div className="relative block md:hidden h-48 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[rgb(var(--charcoal-deep-rgb)/60%)]" />
        </div>

        {/* Left — content */}
        <div className="flex flex-col justify-center px-6 sm:px-10 md:px-12 py-8 sm:py-10 md:py-12 bg-[color:var(--charcoal-deep)] text-white">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <Link
              ...
              className="btn-glow group inline-flex items-center gap-2 justify-center bg-[color:var(--gold)] text-[color:var(--charcoal-deep)] text-sm font-bold px-6 py-2.5 rounded-sharp hover:bg-[color:var(--gold-light)]"
            >
              Dental Treatments For Marathahalli Patients
            ...
            <a
              ...
              onClick={(e) => e.stopPropagation()}
              className="inline-flex items-center justify-center bg-[color:var(--teal)] text-white text-sm font-bold px-6 py-2.5 rounded-lg hover:bg-[color:var(--dk)] transition-colors"
            >
              WhatsApp
            </a>
          </div>
        ...
        <div className="relative hidden md:block overflow-hidden group min-h-[300px]">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[color:var(--charcoal-deep)] via-transparent to-transparent" />

          {/* Floating badge */}
          <div className="absolute top-5 left-6 bg-[rgb(var(--cream-rgb)/95%)] backdrop-blur rounded-sharp px-5 py-3 shadow-xl border border-black/5 animate-float">
            <div className="font-serif text-xl font-bold text-[color:var(--green)] leading-none">Since 2004</div>
            <div className="text-xs text-[color:var(--warm-gray)] mt-0.5">Marathahalli · East Bangalore</div>
          </div>
        </div>
