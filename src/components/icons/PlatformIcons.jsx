...
export const PLATFORM_META = {
  google: { label: 'Google', Icon: GoogleIcon, starColor: '#FBBC04', brandColor: '#4285F4' },
  practo: { label: 'Practo', Icon: PractoIcon, starColor: '#1BBC9B', brandColor: '#2D3293' },
  justdial: { label: 'Justdial', Icon: JustDialIcon, starColor: '#F4731D', brandColor: '#F4731D' },
};
